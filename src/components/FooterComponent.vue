<template>
    <footer>
        <div class="container-fluid">
            <h6> 😅 페이지 하단에 구현된 부분(Footer)은 추후 페이지 연결 및 기능 구현 예정입니다. (현재 작동 x)
            </h6> <br />
            <div class="row">
                <div class="col-sm">
                    <div class="row">
                        ...
                        <div class="sns_link">
                            ...
                            <span><a href="https://www.instagram.com" target="_blank" title="Instagram"
                                    onclick="window.dataLayer.push({event: 'sns_click',channel: 'instagram'});"><img
                                        src="@/assets/images/footer/ic_instagram.gif" alt="Instagram"
                                        width="24" /></a></span>
        ...
        <div class="copyright">
            ...
            <p>
                &copy;2020 - 2024 campingOnTop. All rights reserved </p>
        </div>
    </footer>
</template>
